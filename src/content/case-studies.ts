...
export const caseStudies: CaseStudy[] = [
...

  {
    ...
    video: 'https://res.cloudinary.com/dryyhpqew/video/upload/v1782509417/chevron-reel_is1q7l.mp4',
    featured: true,
    order: 1,
...
• More than just a deck, it helped shape the company’s investor-facing identity and set a high bar for storytelling going forward.`,
...

  {
    ...
    video: 'https://res.cloudinary.com/dryyhpqew/video/upload/v1782509418/philips-reel_omh7sl.mp4',
    featured: false,
    agency: 'Blondefish',
...
• Delivered animated, facilitator-ready slides with smooth pacing cues`,
...

  {
    ...
    video: 'https://res.cloudinary.com/dryyhpqew/video/upload/v1782509414/opmg-reel_ywwygm.mp4',
    featured: false,
...
• Built strong investor confidence through credible market analysis and a strong narrative of growth`,
...

  {
    ...
    video: 'https://res.cloudinary.com/dryyhpqew/video/upload/v1782509410/project-be-wellness_qew0kx.mp4',
    featured: false,
