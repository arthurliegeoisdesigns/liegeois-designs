  ...
  return (
    <motion.div
      style={{
        rotateX: rotate,
        scale,
        boxShadow: '0 60px 120px rgba(0,0,0,0.55), 0 20px 40px rgba(0,0,0,0.35)',
      }}
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full"
      // Brand: zero radius, no decorative border — let the content speak
    >
      <div className="h-full w-full overflow-hidden" style={{ background: 'var(--color-void)' }}>
        {children}
      </div>
    </motion.div>
  );
